...
namespace PEDIS
{
    public partial class CustomerCompanyPanel : UserControl
    {
        ...
        {
            MessageBox.Show("Add Company - Feature coming soon", "Not Implemented", MessageBoxButtons.OK);
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Edit Company - Feature coming soon", "Not Implemented", MessageBoxButtons.OK);
        }
